...
image:https://travis-ci.org/neo4j-contrib/neo4j-jdbc.svg?branch=2.3["Build Status", link="https://travis-ci.org/neo4j-contrib/neo4j-jdbc"]
...
Here is a binary download of the https://m2.neo4j.org/content/repositories/releases/org/neo4j/neo4j-jdbc/2.3.2/neo4j-jdbc-2.3.2-jar-with-dependencies.jar[Neo4j-2.3.2 Version]
